...
ActiveRecord::Schema.define(version: 2017_09_29_194112) do
  ...
  create_table "archived_files", id: :serial, force: :cascade do |t|
    t.string "name", limit: 255
    t.integer "activity_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["activity_id"], name: "index_archived_files_on_activity_id"
  end

  create_table "asq_statuses", id: :serial, force: :cascade do |t|
  ...
  create_table "asqs", id: :serial, force: :cascade do |t|
    t.string "name", limit: 255
    t.text "description"
    t.text "query"
  ...
  create_table "deliveries", id: :serial, force: :cascade do |t|
    ...
    t.index ["asq_id"], name: "index_deliveries_on_asq_id"
    t.index ["deliverable_id"], name: "index_deliveries_on_deliverable_id"
    t.index ["deliverable_type"], name: "index_deliveries_on_deliverable_type"
  end

  create_table "direct_ftp_deliveries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["asq_id"], name: "index_direct_ftp_deliveries_on_asq_id"
  end

  create_table "direct_sftp_deliveries", id: :serial, force: :cascade do |t|
    t.string "host", limit: 255
    t.integer "port"
    t.string "directory", limit: 255
    t.string "username", limit: 255
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["asq_id"], name: "index_direct_sftp_deliveries_on_asq_id"
  end
  ...
  create_table "email_deliveries", id: :serial, force: :cascade do |t|
    ...
    t.index ["asq_id"], name: "index_email_deliveries_on_asq_id"
  end

  create_table "file_options", id: :serial, force: :cascade do |t|
    t.integer "asq_id"
    t.string "name", limit: 255
    ...
    t.index ["asq_id"], name: "index_file_options_on_asq_id"
  end

  create_table "graphite_deliveries", id: :serial, force: :cascade do |t|
    t.integer "asq_id"
    t.string "host"
    t.string "port"
    t.string "prefix"
    ...
    t.index ["asq_id"], name: "index_graphite_deliveries_on_asq_id"
  end

  create_table "json_deliveries", id: :serial, force: :cascade do |t|
    t.string "url", limit: 255
    t.integer "asq_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["asq_id"], name: "index_json_deliveries_on_asq_id"
  end
  ...
  create_table "schedules", id: :serial, force: :cascade do |t|
    ...
    t.index ["asq_id"], name: "index_schedules_on_asq_id"
  end
  ...
  create_table "third_party_hooks", id: :serial, force: :cascade do |t|
    t.string "name", limit: 255
    t.string "url", limit: 255
  ...
  create_table "zenoss_deliveries", id: :serial, force: :cascade do |t|
    t.integer "asq_id"
    t.boolean "enabled"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["asq_id"], name: "index_zenoss_deliveries_on_asq_id"
  end
